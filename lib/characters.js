...
export const CHARACTERS = [
  ...
  { id: "nimrod", name: "Nimrod", era: "creation", storyGroup: "babel", generation: 12, parentIds: [], spouseIds: [], significance: "minor", blurb: "A grandson of Ham described as \"a mighty hunter before the LORD\" and founder of Babylon and other early cities." },
  ...
  { id: "laban", name: "Laban", era: "patriarchs", storyGroup: "jacob_family", generation: 21, parentIds: [], spouseIds: [], significance: "minor", blurb: "Rebekah's brother and father of Leah and Rachel, who employed Jacob for many years and repeatedly changed his wages." },
  ...
  { id: "joshua", name: "Joshua", era: "egypt_exodus", storyGroup: "conquest", generation: 27, parentIds: [], spouseIds: [], significance: "major", blurb: "Moses's assistant and eventual successor, who led Israel across the Jordan and conquered the promised land, including the fall of Jericho." },
  { id: "caleb", name: "Caleb", era: "egypt_exodus", storyGroup: "conquest", generation: 27, parentIds: [], spouseIds: [], significance: "major", blurb: "One of the twelve spies sent into Canaan; alongside Joshua, he trusted God's promise and was rewarded by living to enter the promised land." },
  { id: "salmon", name: "Salmon", era: "judges", storyGroup: "ruth", generation: 28, parentIds: [], spouseIds: ["rahab"], significance: "minor", blurb: "A leader of the tribe of Judah; tradition identifies his wife as Rahab of Jericho, making them Boaz's parents." },
  ...
  { id: "deborah", name: "Deborah", era: "judges", storyGroup: "judges", generation: 30, parentIds: [], spouseIds: [], significance: "major", blurb: "A prophetess and the only female judge of Israel, who led the nation to victory over the Canaanites alongside the general Barak." },
  { id: "barak", name: "Barak", era: "judges", storyGroup: "judges", generation: 30, parentIds: [], spouseIds: [], significance: "minor", blurb: "The military commander who, at Deborah's urging, led Israel's army to defeat the Canaanite general Sisera." },
  { id: "gideon", name: "Gideon", era: "judges", storyGroup: "judges", generation: 31, parentIds: [], spouseIds: [], significance: "major", blurb: "A judge who, with just 300 men, defeated a massive Midianite army after God reduced his forces to prove the victory was the Lord's." },
  ...
  { id: "jephthah", name: "Jephthah", era: "judges", storyGroup: "judges", generation: 32, parentIds: [], spouseIds: [], significance: "minor", blurb: "A judge and military leader remembered for a rash vow made before battle that led to great personal tragedy." },
  { id: "samson", name: "Samson", era: "judges", storyGroup: "judges", generation: 33, parentIds: [], spouseIds: ["delilah"], significance: "major", blurb: "A judge of immense God-given strength, set apart as a Nazirite from birth, whose downfall came through his relationship with Delilah." },
  ...
  { id: "manoah", name: "Manoah", era: "judges", storyGroup: "judges", generation: 32, parentIds: [], spouseIds: [], significance: "minor", blurb: "Samson's father, visited by an angel who foretold his son's birth and calling." },
  { id: "elimelech", name: "Elimelech", era: "judges", storyGroup: "ruth", generation: 33, parentIds: [], spouseIds: ["naomi"], significance: "minor", blurb: "Naomi's husband, who moved his family to Moab during a famine; he died there, leaving Naomi widowed." },
  ...
  { id: "eli", name: "Eli", era: "united_kingdom", storyGroup: "samuel", generation: 34, parentIds: [], spouseIds: [], significance: "minor", blurb: "The priest and judge who raised the young Samuel at the tabernacle in Shiloh; his own sons' corruption brought judgment on his household." },
  ...
  { id: "elkanah", name: "Elkanah", era: "united_kingdom", storyGroup: "samuel", generation: 34, parentIds: [], spouseIds: ["hannah"], significance: "minor", blurb: "Samuel's father, a Levite whose two wives were Hannah and Peninnah." },
  ...
  { id: "kish", name: "Kish", era: "united_kingdom", storyGroup: "saul_family", generation: 35, parentIds: [], spouseIds: [], significance: "minor", blurb: "A Benjamite and the father of King Saul." },
  ...
  { id: "joab", name: "Joab", era: "united_kingdom", storyGroup: "davidic_line", generation: 33, parentIds: [], spouseIds: [], significance: "minor", blurb: "David's ruthless and loyal military commander throughout much of his reign." },
  ...
  { id: "jeroboam", name: "Jeroboam", era: "divided_kingdom", storyGroup: "israel_kings", generation: 35, parentIds: [], spouseIds: [], significance: "minor", blurb: "The first king of the northern kingdom of Israel after the split, remembered for setting up golden calves that led the nation into idolatry." },
  ...
  { id: "naboth", name: "Naboth", era: "divided_kingdom", storyGroup: "israel_kings", generation: 38, parentIds: [], spouseIds: [], significance: "minor", blurb: "An Israelite whose vineyard Ahab coveted; Jezebel had him falsely accused and executed to seize it." },
  { id: "elijah", name: "Elijah", era: "divided_kingdom", storyGroup: "prophets", generation: 38, parentIds: [], spouseIds: [], significance: "major", blurb: "A fiery prophet who confronted Ahab and Jezebel, defeated the prophets of Baal at Mount Carmel, and was taken up to heaven in a whirlwind." },
  { id: "elisha", name: "Elisha", era: "divided_kingdom", storyGroup: "prophets", generation: 39, parentIds: [], spouseIds: [], significance: "major", blurb: "Elijah's successor, who received a double portion of his mentor's spirit and performed numerous miracles during the reigns of several kings." },
  ...
  { id: "asa", name: "Asa", era: "divided_kingdom", storyGroup: "judah_kings", generation: 37, parentIds: [], spouseIds: [], significance: "minor", blurb: "A king of Judah remembered for his early religious reforms, removing idols from the land." },
  ...
  { id: "hezekiah", name: "Hezekiah", era: "divided_kingdom", storyGroup: "judah_kings", generation: 46, parentIds: [], spouseIds: [], significance: "major", blurb: "A reforming king of Judah who trusted God during the Assyrian siege of Jerusalem and whose prayer extended his life by fifteen years." },
  { id: "isaiah", name: "Isaiah", era: "divided_kingdom", storyGroup: "prophets", generation: 46, parentIds: [], spouseIds: [], significance: "major", blurb: "A major prophet during the reigns of several kings of Judah, whose writings contain some of the Bible's clearest prophecies about the coming Messiah." },
  ...
  { id: "josiah", name: "Josiah", era: "divided_kingdom", storyGroup: "judah_kings", generation: 49, parentIds: [], spouseIds: [], significance: "major", blurb: "A young king of Judah who led a major religious reform after the Book of the Law was rediscovered in the Temple during his reign." },
  { id: "jeremiah", name: "Jeremiah", era: "divided_kingdom", storyGroup: "prophets", generation: 49, parentIds: [], spouseIds: [], significance: "major", blurb: "The \"weeping prophet,\" who warned Judah of coming judgment for decades and witnessed Jerusalem's fall to Babylon." },
  { id: "baruch", name: "Baruch", era: "divided_kingdom", storyGroup: "prophets", generation: 49, parentIds: [], spouseIds: [], significance: "minor", blurb: "Jeremiah's faithful scribe, who recorded and read aloud the prophet's warnings." },
  ...
  { id: "daniel", name: "Daniel", era: "exile_return", storyGroup: "babylon", generation: 51, parentIds: [], spouseIds: [], significance: "major", blurb: "A young Israelite exile who rose to prominence in the Babylonian and Persian courts through wisdom and faithfulness, famously surviving a night in a lions' den." },
  { id: "shadrach_meshach_abednego", name: "Shadrach, Meshach & Abednego", era: "exile_return", storyGroup: "babylon", generation: 51, parentIds: [], spouseIds: [], significance: "minor", blurb: "Daniel's three companions in exile, who were thrown into a fiery furnace for refusing to worship a golden image and were miraculously preserved." },
  { id: "ezekiel", name: "Ezekiel", era: "exile_return", storyGroup: "babylon", generation: 51, parentIds: [], spouseIds: [], significance: "major", blurb: "A priest-turned-prophet among the exiles in Babylon, known for vivid visions including the valley of dry bones." },
  ...
  { id: "esther", name: "Esther", era: "exile_return", storyGroup: "esther", generation: 52, parentIds: [], spouseIds: ["ahasuerus"], significance: "major", blurb: "A Jewish woman who became queen of Persia and courageously risked her life to expose a plot to destroy her people, saving them from genocide." },
  { id: "mordecai", name: "Mordecai", era: "exile_return", storyGroup: "esther", generation: 52, parentIds: [], spouseIds: [], significance: "major", blurb: "Esther's older cousin and guardian, who raised her and uncovered the plot against the Jewish people that she ultimately foiled." },
  ...
  { id: "zerubbabel", name: "Zerubbabel", era: "exile_return", storyGroup: "return", generation: 52, parentIds: [], spouseIds: [], significance: "major", blurb: "A descendant of David who led the first group of exiles back to Jerusalem and oversaw the rebuilding of the Temple." },
  { id: "ezra", name: "Ezra", era: "exile_return", storyGroup: "return", generation: 53, parentIds: [], spouseIds: [], significance: "major", blurb: "A priest and scribe who led a later group of exiles back to Jerusalem and worked to restore faithfulness to God's law among the people." },
  { id: "nehemiah", name: "Nehemiah", era: "exile_return", storyGroup: "return", generation: 53, parentIds: [], spouseIds: [], significance: "major", blurb: "A Jewish official in the Persian court who returned to Jerusalem to rebuild its broken walls despite fierce opposition." },
  { id: "zechariah_priest", name: "Zechariah", era: "gospels", storyGroup: "jesus_birth", generation: 58, parentIds: [], spouseIds: ["elizabeth"], significance: "minor", blurb: "A priest struck mute for doubting the angel Gabriel's announcement that his elderly wife Elizabeth would bear a son, John the Baptist." },
  { id: "elizabeth", name: "Elizabeth", era: "gospels", storyGroup: "jesus_birth", generation: 58, parentIds: [], spouseIds: ["zechariah_priest"], significance: "minor", blurb: "John the Baptist's mother and a relative of Mary, whose own miraculous pregnancy in old age prefigured the announcement to Mary." },
  ...
  { id: "joseph_husband_of_mary", name: "Joseph", era: "gospels", storyGroup: "jesus_birth", generation: 59, parentIds: [], spouseIds: ["mary_mother_of_jesus"], significance: "major", blurb: "Mary's husband, a carpenter of Bethlehem descended from David, who raised Jesus as his own son and protected the family by fleeing to Egypt." },
...
export function layoutTree(characters) {
  ...
  gens.forEach((gen) => {
    ...
    // centered under its parents' midpoint as a single block.
    const clusters = {}
    const orphans = []
    selfPlaced.forEach((c) => {
      const knownParents = c.parentIds.filter((pid) => slotX[pid] !== undefined)
